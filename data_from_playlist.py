...
if __name__ == '__main__':
    action = int(input("select 1 for dump release dates and genres per son into txt files" + '\n' + 
    ...
    if (action == 1):
        ...
        try:
            ...
            raise Exception('no se pudo obtener la lista de {cant} canciones de la playlist {url}'.format(cant = cantidad, url = playlist))
